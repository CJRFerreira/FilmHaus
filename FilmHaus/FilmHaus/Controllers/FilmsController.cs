...
namespace FilmHaus.Controllers
{
    public class FilmsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FilmId,FilmName,DateOfRelease,Runtime,Rating,Accolades")] Film film)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FilmId,FilmName,DateOfRelease,Runtime,Rating,Accolades")] Film film)
        {
            if (ModelState.IsValid)
            {
